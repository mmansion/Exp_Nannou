...
impl TouchOscClient {
    ...
    pub fn fader(&self, path: &'static str) -> &TouchOscFader {
        //&'static str
        return &self.touchosc_faders[path];
    }

    pub fn button(&self, path: &'static str) -> &TouchOscButton {
        //&'static str
    ...
    pub fn add_fader(&mut self, path: &'static str) {
        self.touchosc_faders
            .insert(path.to_string(), TouchOscFader::new(path.to_string()));
    }

    pub fn add_button(&mut self, path: &'static str) {
        self.touchosc_buttons
            .insert(path.to_string(), TouchOscButton::new(path.to_string()));
    }
}
//--------------------------------------------------------
